...
A: 二分查找的变形，旋转数组的首元素肯定不小于旋转数组的尾元素，找一个中间点，如果中间点比首元素大，说明最小数字在中间点后面，如果中间点比尾元素小，说明最小数字在中间点前面。然后循环。
循环的判断条件就是首元素永远比尾元素大1. 
    ...
    def minNumberInRotateArray(self, rotateArray):
        ...
        while (last - first) > 1:
            ...
            if rotateArray[mid] >= rotateArray[first]:
                ...
                last = mid
            elif rotateArray[first] == rotateArray[mid] == rotate[last]:
